						...
						<ul>
							...
							<li class="has-sub">
								...
								<ul class="sub">
									...
									<li><a class="" href="wizards_validations.php"><span class="sub-menu-text">Wizards & Validations</span></a></li>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									...
									<li class="current"><a class="" href="error_404.php"><span class="sub-menu-text">Error 404 Option 1</span></a></li>
						...
						<div class="col-md-4 col-md-offset-4 not-found text-center">
						   <div class="content">
							  ...
							  <p>
								 ...
								 Try checking the URL for errors, <a href="index.php">goto home</a> or try to search below.
							  </p>
							  <form action="#">
