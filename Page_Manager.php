...
if(isset($_REQUEST["did"]))
{
	$sql="DELETE FROM tbl_pagemanager WHERE PM_ID=".$_REQUEST["did"];
	  mysqli_query($con,$sql);
}

if(isset($_REQUEST["btn_Submit"]))
{
	$sql="INSERT INTO tbl_pagemanager
 (Title,Content) VALUES ('".$_REQUEST["txt_Title"]."','".$_REQUEST["txt_Content"]."')";
    mysqli_query($con,$sql);
}

if(isset($_REQUEST["btn_SubmitE"]))
{
	$sql="UPDATE tbl_pagemanager SET Title='".$_REQUEST["txt_TitleE"]."',Content='".$_REQUEST["txt_ContentE"]."' where PM_ID=".$_REQUEST["eid"];
    mysqli_query($con,$sql);
}
					...
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">Page Manager</h3>
										<!-- DATE RANGE PICKER -->
										<?php
						...
						<div class="row">
							...
							<div class="box border pink">
									<div class="box-title">
										<h4><i class="fa fa-table"></i>Page Manager</h4>
										<div class="tools">
									...
									<div class="box-body">
									 ...
									 <tr>
									  <td>
											<thead>
											  <tr>
												<th><a href="Page_Manager.php?id=2">Add</a></th>
										...
										<?php
                                          $sql="SELECT * FROM tbl_pagemanager";
                                          $i=1;
                                        ...
                                        ?> 
											...
											<tbody>
											  <tr>
												...
												<td><a href="Page_Manager.php?did=<?php echo $row["PM_ID"]; ?>">Delete</a></td>
                                                <td><a href="Page_Manager.php?id=3&eid=<?php echo $row["PM_ID"]; ?>">Edit</a></td>
                                     ...
                                     ?>
											...
											<div class="box-body big">
												<form class="form-horizontal" role="form" action="" method="post">
												  <div class="form-group">
													<label class="col-sm-3 control-label"><a href="Page_Manager.php?id=1">Back</a></label>
									  ...
									  <?php 
	                                   if( isset($_REQUEST["id"]) && $_REQUEST["id"]=="3")
	                                    {  
	                                     $sql="SELECT * FROM tbl_pagemanager where PM_ID=".$_REQUEST["eid"];
                                         $tbl=mysqli_query($con,$sql);
                                         if($tbl)
                                          {
