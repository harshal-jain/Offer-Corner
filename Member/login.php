...
{ 
	$sql="SELECT * FROM tbl_shops where Contact_Email='".$_REQUEST["txt_Email"]."' and Password='".$_REQUEST["txt_Password"]."'";
	...
	if($tbl)
		...
		{
			echo "either Email no or password is wrong";
		}
}
?>
							...
							<div class="login-box-plain">
								...
								<form role="form" method="post">
								  <div class="form-group">
									...
									<input type="email" class="form-control"  name="txt_Email" id="exampleInputEmail1" >
								  </div>
								  <div class="form-group"> 
