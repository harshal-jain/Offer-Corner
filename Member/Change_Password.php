...
{ 
	...
	if($tbl)
		...
		{
			$sql="UPDATE tbl_shops SET Password ='".$_REQUEST["txt_NewPassword"]."' where ID='".$_SESSION["RegId"]."' and Password ='".$_REQUEST["txt_CurrentPassword"]."'" ;
											...
											<div class="box-body big">
												<form class="form-horizontal" role="form">
												  ...
												  <div class="form-group">
													...
													<div class="col-sm-9">
													  <input class="form-control" id="focusedInput" type="text" name="txt_CurrentPassword">
													</div>
												  </div>
												  <div class="form-group">
													<label class="col-sm-3 control-label">New Password</label>
													<div class="col-sm-9">
													  <input class="form-control" id="focusedInput" type="text" name="txt_NewPassword">
													</div>
												  </div>
												  <div class="form-group">
													<label class="col-sm-3 control-label">Confirm Password</label>
													<div class="col-sm-9">
														<input type="text"  title="Tooltip on focus" class="form-control tip-focus" name="txt_ConfirmPassword">
													</div>
												  </div>
